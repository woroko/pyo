...
#include "MedianFilter.h" // include median filter
...
typedef struct {
	...
	sMedianNode_t *medianBuffer;
	
} Median;

static void
Median_process_i(Median *self) {
    int i;
	...
	for (i=0; i<self->bufsize; i++) {
		...
		self->data[i] = (MYFLT)MEDIANFILTER_Insert(&self->medianFilter, self->currentValue);
	}
}

static void Median_postprocessing_ii(Median *self) { POST_PROCESSING_II };
static void Median_postprocessing_ai(Median *self) { POST_PROCESSING_AI };
static void Median_postprocessing_ia(Median *self) { POST_PROCESSING_IA };
static void Median_postprocessing_aa(Median *self) { POST_PROCESSING_AA };
static void Median_postprocessing_ireva(Median *self) { POST_PROCESSING_IREVA };
static void Median_postprocessing_areva(Median *self) { POST_PROCESSING_AREVA };
static void Median_postprocessing_revai(Median *self) { POST_PROCESSING_REVAI };
static void Median_postprocessing_revaa(Median *self) { POST_PROCESSING_REVAA };
static void Median_postprocessing_revareva(Median *self) { POST_PROCESSING_REVAREVA };

static void
Median_setProcMode(Median *self)
{
    int muladdmode;
    muladdmode = self->modebuffer[0] + self->modebuffer[1] * 10;

    self->proc_func_ptr = Median_process_i;

	switch (muladdmode) {
        case 0:
            self->muladd_func_ptr = Median_postprocessing_ii;
            break;
        case 1:
            self->muladd_func_ptr = Median_postprocessing_ai;
            break;
        case 2:
            self->muladd_func_ptr = Median_postprocessing_revai;
            break;
        case 10:
            self->muladd_func_ptr = Median_postprocessing_ia;
            break;
        case 11:
            self->muladd_func_ptr = Median_postprocessing_aa;
            break;
        case 12:
            self->muladd_func_ptr = Median_postprocessing_revaa;
            break;
        case 20:
            self->muladd_func_ptr = Median_postprocessing_ireva;
            break;
        case 21:
            self->muladd_func_ptr = Median_postprocessing_areva;
            break;
        case 22:
            self->muladd_func_ptr = Median_postprocessing_revareva;
            break;
    }
}

static void
Median_compute_next_data_frame(Median *self)
{
    (*self->proc_func_ptr)(self);
    (*self->muladd_func_ptr)(self);
}
...
static int
Median_traverse(Median *self, visitproc visit, void *arg)
{
    pyo_VISIT
    Py_VISIT(self->input);
    Py_VISIT(self->input_stream);
...
static void
Median_dealloc(Median* self)
{
    pyo_DEALLOC
    free(self->buffer);
    Median_clear(self);
	free(self->medianBuffer);
    Py_TYPE(self)->tp_free((PyObject*)self);
}

static PyObject *
Median_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    int i;
    PyObject *inputtmp, *input_streamtmp, *multmp=NULL, *addtmp=NULL;
    Median *self;
    self = (Median *)type->tp_alloc(type, 0);

    self->size = 3; // default window for median filter
    self->init = 1;
    self->in_count = 0;
    ...
    INIT_OBJECT_COMMON
    Stream_setFunctionPtr(self->stream, Median_compute_next_data_frame);
    self->mode_func_ptr = Median_setProcMode;
	...
	self->medianBuffer = malloc(self->size * sizeof(struct sMedianNode));
	self->medianFilter.numNodes = self->size;
	self->medianFilter.medianBuffer = self->medianBuffer;
	MEDIANFILTER_Init(&self->medianFilter);
...
static PyObject * Median_getServer(Median* self) { GET_SERVER };
static PyObject * Median_getStream(Median* self) { GET_STREAM };
static PyObject * Median_setMul(Median *self, PyObject *arg) { SET_MUL };
static PyObject * Median_setAdd(Median *self, PyObject *arg) { SET_ADD };
static PyObject * Median_setSub(Median *self, PyObject *arg) { SET_SUB };
static PyObject * Median_setDiv(Median *self, PyObject *arg) { SET_DIV };

static PyObject * Median_play(Median *self, PyObject *args, PyObject *kwds) { PLAY };
static PyObject * Median_out(Median *self, PyObject *args, PyObject *kwds) { OUT };
static PyObject * Median_stop(Median *self, PyObject *args, PyObject *kwds) { STOP };

static PyObject * Median_multiply(Median *self, PyObject *arg) { MULTIPLY };
static PyObject * Median_inplace_multiply(Median *self, PyObject *arg) { INPLACE_MULTIPLY };
static PyObject * Median_add(Median *self, PyObject *arg) { ADD };
static PyObject * Median_inplace_add(Median *self, PyObject *arg) { INPLACE_ADD };
static PyObject * Median_sub(Median *self, PyObject *arg) { SUB };
static PyObject * Median_inplace_sub(Median *self, PyObject *arg) { INPLACE_SUB };
static PyObject * Median_div(Median *self, PyObject *arg) { DIV };
static PyObject * Median_inplace_div(Median *self, PyObject *arg) { INPLACE_DIV };

static PyObject *
Median_setSize(Median *self, PyObject *arg)
{
	int i;
...
static PyMemberDef Median_members[] = {
    {"server", T_OBJECT_EX, offsetof(Median, server), 0, "Pyo server."},
    {"stream", T_OBJECT_EX, offsetof(Median, stream), 0, "Stream object."},
    {"input", T_OBJECT_EX, offsetof(Median, input), 0, "Input sound object."},
    {"mul", T_OBJECT_EX, offsetof(Median, mul), 0, "Mul factor."},
    {"add", T_OBJECT_EX, offsetof(Median, add), 0, "Add factor."},
    {NULL}  /* Sentinel */
};

static PyMethodDef Median_methods[] = {
    {"getServer", (PyCFunction)Median_getServer, METH_NOARGS, "Returns server object."},
    {"_getStream", (PyCFunction)Median_getStream, METH_NOARGS, "Returns stream object."},
    {"play", (PyCFunction)Median_play, METH_VARARGS|METH_KEYWORDS, "Starts computing without sending sound to soundcard."},
    {"out", (PyCFunction)Median_out, METH_VARARGS|METH_KEYWORDS, "Starts computing and sends sound to soundcard channel speficied by argument."},
    {"stop", (PyCFunction)Median_stop, METH_VARARGS|METH_KEYWORDS, "Stops computing."},
	{"setSize", (PyCFunction)Median_setSize, METH_O, "Sets filter kernel size."},
	{"setMul", (PyCFunction)Median_setMul, METH_O, "Sets oscillator mul factor."},
	{"setAdd", (PyCFunction)Median_setAdd, METH_O, "Sets oscillator add factor."},
    {"setSub", (PyCFunction)Median_setSub, METH_O, "Sets inverse add factor."},
    {"setDiv", (PyCFunction)Median_setDiv, METH_O, "Sets inverse mul factor."},
    {NULL}  /* Sentinel */
};

static PyNumberMethods Median_as_number = {
    (binaryfunc)Median_add,                      /*nb_add*/
    (binaryfunc)Median_sub,                 /*nb_subtract*/
    (binaryfunc)Median_multiply,                 /*nb_multiply*/
    INITIALIZE_NB_DIVIDE_ZERO               /*nb_divide*/
    0,                /*nb_remainder*/
    0,                   /*nb_divmod*/
    0,                   /*nb_power*/
    ...
    INITIALIZE_NB_OCT_ZERO   /*nb_oct*/
    INITIALIZE_NB_HEX_ZERO   /*nb_hex*/
    (binaryfunc)Median_inplace_add,              /*inplace_add*/
    (binaryfunc)Median_inplace_sub,         /*inplace_subtract*/
    (binaryfunc)Median_inplace_multiply,         /*inplace_multiply*/
    INITIALIZE_NB_IN_PLACE_DIVIDE_ZERO        /*inplace_divide*/
    0,        /*inplace_remainder*/
    0,           /*inplace_power*/
    0,       /*inplace_lshift*/
    ...
    0,       /*inplace_or*/
    0,             /*nb_floor_divide*/
    (binaryfunc)Median_div,                       /*nb_true_divide*/
    0,     /*nb_inplace_floor_divide*/
    (binaryfunc)Median_inplace_div,                       /*nb_inplace_true_divide*/
    0,                     /* nb_index */
};

PyTypeObject MedianType = {
    PyVarObject_HEAD_INIT(NULL, 0)
    "_pyo.Median_base",         /*tp_name*/
    sizeof(Median),         /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)Median_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_as_async (tp_compare in Python 2)*/
    0,                         /*tp_repr*/
    &Median_as_number,             /*tp_as_number*/
    0,                         /*tp_as_sequence*/
    0,                         /*tp_as_mapping*/
    0,                         /*tp_hash */
    0,                         /*tp_call*/
    ...
    0,                         /*tp_as_buffer*/
    Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE | Py_TPFLAGS_HAVE_GC | Py_TPFLAGS_CHECKTYPES, /*tp_flags*/
    "Median objects. Moving average filter.",           /* tp_doc */
    (traverseproc)Median_traverse,   /* tp_traverse */
    (inquiry)Median_clear,           /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    Median_methods,             /* tp_methods */
    Median_members,             /* tp_members */
    0,                      /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
